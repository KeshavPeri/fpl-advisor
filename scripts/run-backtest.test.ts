...
// ============================================================================
// FIXTURE-AWARE EXPECTED SCORE — ticket #175. buildTeamMatchRecords/
// computeTeamStrengthAsOf/teamStrengthRate/fixtureHasSufficientHistory/
// computeFixtureExpectedScore's own unit tests moved to
// src/lib/projection/teamStrength.test.ts by ticket #229 (see that file's
// own header and this file's import comment). What remains below —
// buildClubFixtureSchedule (ticket #193) and resolveFixtureTeams — is not
// part of that move; both still live in run-backtest.ts.
// ============================================================================
