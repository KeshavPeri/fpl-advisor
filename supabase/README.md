...
| `20260811190000_squad_api_sync_fields.sql` | Adds the sync-metadata columns #14's squad sync writes. | **VERIFY — not confirmed applied.** Ticket #14. Check before trusting any sync run. |
